...
if (typeof APURI.replaceBoxesAction !== 'function') {
	APURI.replaceBoxesAction = function() {
	};
}

if (typeof APURI.replaceBoxes !== 'function') {
	APURI.replaceBoxes = function() {
		APURI.replaceBoxesAction();
	};
}
/*
window.CKEDITOR_BASEPATH = 'https://klo33.github.io/javascript/ckeditor/';
		$.getScript('https://klo33.github.io/javascript/ckeditor/ckeditor.js', function (data, textStatus, jqxhr) {
			if (jqxhr.status == 200) {
*/
	APURI.replaceBoxesAction = function() {
...
/*
		...
		// APURI.loadRequireJs('Sortable', 'https://rubaxa.github.io/Sortable/Sortable');
